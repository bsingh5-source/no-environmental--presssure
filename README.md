...
<body class="bg-slate-100 min-h-screen pb-12">
    ...
    <script>
        ...
        function downloadResults() {
            ...
            a.href = url;
            a.download = `Trial_${currentTrial}.csv`;
            a.click();
        }
                ...
                html += `
                    <div class="border rounded-lg p-4">
                        ...
                        <table class="text-sm w-full">
                            <thead class="bg-gray-100"><tr><th class="p-1">Gen</th><th class="p-1">Genotype</th></tr></thead>
                            <tbody>
                                ${trials[t].data.map((geno, idx) => 
                                    `<tr class="border-t"><td class="p-1">${idx + 1}</td><td class="p-1 font-bold">${geno}</td></tr>`
                                ).join('')}
                            </tbody>
                        </table>
                    </div>
